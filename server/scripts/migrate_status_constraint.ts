...
async function migrate() {
    ...
    try {
        ...
        try { await pool.query('DROP TABLE IF EXISTS reports_old'); } catch (e: any) { console.error('Error dropping reports_old:', e); }
        ...
        try { await pool.query('DROP TABLE IF EXISTS matches_old'); } catch (e: any) { console.error('Error dropping matches_old:', e); }
        try { await pool.query('ALTER TABLE matches RENAME TO matches_old'); } catch (e: any) { console.error('Error renaming matches to matches_old:', e); }
        ...
        try { await pool.query('DROP TABLE IF EXISTS reviews_old'); } catch (e: any) { console.error('Error dropping reviews_old:', e); }
        try { await pool.query('ALTER TABLE reviews RENAME TO reviews_old'); } catch (e: any) { console.error('Error renaming reviews to reviews_old:', e); }
