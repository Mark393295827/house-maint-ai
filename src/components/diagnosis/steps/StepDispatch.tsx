...
const StepDispatch: React.FC<StepDispatchProps> = ({ diagnosis, locale, onDispatch }) => {
    ...
    return (
        <div className="relative h-full w-full bg-[#ffffff] flex flex-col items-center justify-between text-[#202124] overflow-hidden">
            ...
            {matchingState === 'searching' && (
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-0">
                    <div className="w-[600px] h-[600px] rounded-full border border-[#1a73e8]/5 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 animate-[ping_4s_infinite]" />
                    <div className="w-[400px] h-[400px] rounded-full border border-[#1a73e8]/10 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 animate-[ping_3s_infinite]" />
                    <div className="w-[200px] h-[200px] rounded-full border border-[#1a73e8]/20 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[#1a73e8]/5 backdrop-blur-3xl animate-[pulse_2s_infinite]" />
                    
                    {/* Pulsing Core */}
                    <div className="relative">
                        <div className="w-12 h-12 rounded-[14px] bg-[#202124] flex items-center justify-center shadow-2xl animate-bounce">
                ...
                {matchedWorker && (
                    <div className="group apple-glass bg-white/60 ring-1 ring-black/5 rounded-[32px] p-8 w-full shadow-2xl shadow-black/5 transform hover:-translate-y-1 transition-transform">
                        ...
                        <div className="flex items-center gap-2 mb-8">
                             <div className="px-3 py-1 bg-[#34a853]/10 rounded-full border border-[#34a853]/20">
                                <span className="text-[10px] font-black text-[#34a853] uppercase tracking-widest">{isZh ? '最优匹配' : 'BEST MATCH'}</span>
                             </div>
                        ...
                        <div className="flex items-center gap-6 mb-8">
                            <div className="relative">
                                <div className="absolute inset-0 bg-gradient-to-br from-[#1a73e8] to-[#5e5ce6] rounded-full blur-xl opacity-20 animate-pulse" />
                                ...
                                <div className="absolute -bottom-1 -right-1 bg-white ring-1 ring-black/5 text-[#202124] text-[10px] font-black px-2 py-1 rounded-lg shadow-xl flex items-center gap-1">
                                    <span className="material-symbols-outlined text-[14px] text-[#34a853]">bolt</span>
                                    1.2km
                                </div>
                            </div>
                            <div className="flex-1">
                                <h3 className="text-[#202124] font-black text-2xl tracking-tighter mb-1 leading-tight">{matchedWorker.name}</h3>
                                <div className="flex items-center gap-3">
                                    <div className="flex items-center bg-[#ff9500]/10 px-2 py-0.5 rounded-md">
                                        ...
                                        <span className="font-black text-[#202124] text-xs ml-1">{matchedWorker.rating}</span>
                                    </div>
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-8">
                             ...
                             <div className="apple-glass bg-white/40 ring-1 ring-black/5 p-5 rounded-2xl flex flex-col items-center">
                                 ...
                                 <div className="flex items-baseline gap-1">
                                     <span className="text-2xl font-black tracking-tighter text-[#1a73e8]">
                        ...
                        <button
                            ...
                            className="w-full h-16 bg-[#202124] hover:bg-black text-white rounded-[20px] text-[15px] font-black uppercase tracking-widest flex items-center justify-center gap-3 shadow-[0_20px_40px_rgba(0,0,0,0.1)] press-scale transition-all"
                        >
