    ...
    return (
        <div className="w-full h-full min-h-[140px] sm:min-h-[160px] relative mt-6 lg:mt-10">
            <svg viewBox={`0 0 ${width} ${height}`} className="w-full h-full overflow-visible">
                ...
                <path d={pathData} fill="none" stroke="#1a73e8" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" filter="url(#glow)" />
                
                {/* Active Tooltip Indicator */}
                <circle cx={step * 9} cy={height - (points[9] / 100 * height)} r="6" fill="#1a73e8" stroke="white" strokeWidth="3" className="shadow-xl" />
            </svg>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-8 sm:gap-10 lg:gap-12 mt-6 lg:mt-10">
            <div className="relative w-32 h-32 sm:w-40 sm:h-40 mx-auto sm:mx-0 shrink-0">
                <svg viewBox="0 0 36 36" className="w-full h-full transform -rotate-90">
                    ...
                    <circle cx="18" cy="18" r="16" fill="none" stroke="#1a73e8" strokeWidth="4.5" strokeDasharray="60, 100" strokeLinecap="round" strokeOpacity="0.9" />
                    <circle cx="18" cy="18" r="16" fill="none" stroke="#34a853" strokeWidth="4.5" strokeDasharray="25, 100" strokeDashoffset="-60" strokeLinecap="round" strokeOpacity="0.9" />
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                    <span className="text-3xl sm:text-4xl font-black text-[#202124] tracking-tighter tabular-nums">85%</span>
            ...
            <div className="space-y-4 sm:space-y-5">
                <div className="flex items-center gap-5 group">
                    <div className="w-3.5 h-3.5 rounded-full bg-[#1a73e8] shadow-lg shadow-blue-500/20" />
                    <div>
                        <span className="block text-[13px] font-black text-[#202124] tracking-tight">{t('enterprise.charts.aiCompute')}</span>
                        <span className="text-[11px] font-black text-[#86868b] opacity-60">{t('enterprise.charts.capacity', { value: 60 })}</span>
                    </div>
                </div>
                <div className="flex items-center gap-5 group">
                    <div className="w-3.5 h-3.5 rounded-full bg-[#34a853] shadow-lg shadow-green-500/20" />
                    <div>
                        <span className="block text-[13px] font-black text-[#202124] tracking-tight">{t('enterprise.charts.agentLatency')}</span>
                ...
                <div className="flex items-center gap-5 group">
                    ...
                    <div>
                        <span className="block text-[13px] font-black text-[#202124] tracking-tight">{t('enterprise.charts.systemIdle')}</span>
