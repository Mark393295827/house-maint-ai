...
export const PerformanceChart: React.FC = () => {
    ...
    return (
        <div className="w-full h-full min-h-[160px] relative mt-10">
            ...
            <div className="flex justify-between mt-8 pt-5 border-t border-black/5 text-[9px] text-[#86868b] font-black uppercase tracking-[0.25em]">
                <span>08:00 AM</span>
                <span>12:00 PM</span>
                <span>04:00 PM</span>
                <span>08:00 PM</span>
        ...
        <div className="flex items-center gap-12 mt-10">
            <div className="relative w-40 h-40">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                    <span className="text-4xl font-black text-[#1d1d1f] tracking-tighter tabular-nums">85%</span>
