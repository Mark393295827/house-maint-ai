        ...
        <div className="relative min-h-[100dvh] w-full bg-[#ffffff] font-sans text-[#202124] overflow-x-hidden selection:bg-[#1a73e8]/10">
            ...
            <header className="fixed top-0 inset-x-0 z-50 h-16 apple-glass border-b border-[#d2d2d7]/30 flex items-center justify-between px-6 lg:px-12">
                ...
                <div className="flex items-center gap-4">
                    <LanguageToggle />
                    <Link to="/login" className="text-[12px] font-bold text-[#1557b0] hover:underline px-3 py-1.5">{isZh ? '登录' : 'Sign In'}</Link>
                </div>
            </header>
            ...
            <footer className="relative z-10 py-12 px-6 lg:px-12 border-t border-[#d2d2d7]/30 bg-[#f8f9fa]/50">
                <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-between items-center gap-8">
                    ...
                    <div className="flex gap-8">
                        <Link to="/showcase" className="text-[11px] font-bold text-[#86868b] uppercase tracking-widest hover:text-[#202124] transition-colors">{isZh ? '隐私政策' : 'Privacy'}</Link>
                        <Link to="/showcase" className="text-[11px] font-bold text-[#86868b] uppercase tracking-widest hover:text-[#202124] transition-colors">{isZh ? '服务条款' : 'Terms'}</Link>
                        <Link to="/showcase" className="text-[11px] font-bold text-[#86868b] uppercase tracking-widest hover:text-[#202124] transition-colors">{isZh ? '支持' : 'Support'}</Link>
                    </div>
                </div>
            </footer>
        </div>
